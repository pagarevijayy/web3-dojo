/*
@todo:
- figure out: mainnet apis and block fees calc.
*/
...
module.exports = sendBitcoin = async (recieverAddress, amountToSend) => {
    try {
        // modify as per user
        const privateKey = SOURCE_WALLET.privateKey
        const sourceAddress = SOURCE_WALLET.sourceAddress;
        ...
        fee = transactionSize * 33 // 33 satoshi per byte
